...
# -------------------------
# Pull needed functions / globals from test05.py
# -------------------------
...
def _build_words_array(
    ...
    # Optimize repeated note translations once per request
    punct_note_target = _translate_small_text("Punctuation mark.", target_tag, max_new_tokens=40)
    word_note_target = _translate_small_text(
...
def chat_about_sentence(
    ...
    # Keep same behavior: always return both language replies
    if source_tag == "eng_Latn":
